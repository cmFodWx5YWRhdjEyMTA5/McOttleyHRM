...
<script type='text/javascript'>
	function redirect() {
		window.location.href = '\x2Faccounts\x2Fannouncement\x2Ftfa\x2Dbanner\x2Fnext\x3Fstatus\x3D2\x26serviceurl\x3Dhttps\x253A\x252F\x252Fpeople.zoho.com\x252Fpeople\x252F\x26servicename\x3Dzohopeople';
		return;
	}
</script>
</head>
...
<td valign="top">
<div class="maindiv">
	<div style="border-right:1px solid #8d8d8d;width: 235px;float: left;"><div class='title-banner'>Stronger security for your McPersona Account</div>
...
<div style="font-size:10px;text-align:center;padding:5px 0px;">
			&copy;&nbsp;2017,&nbsp;<a href="#" title="OmniLabsGh Corp." target="_blank" style="font-size:11px;color:#085ddc;">McPersona.</a>&nbsp;All rights reserved.
</div>	</footer>
</td></tr>
</table>
</body>
