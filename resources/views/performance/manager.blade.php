                       ...
                       <table id="JobTable" cellpadding="0" cellspacing="0" border="0" class="table table-striped m-b-none text-sm" width="100%">
                         <thead>
                          ...
                          <tr>
                            ...
                            <td><input name="weight[]" id="weight"  value="{{ $kpa->weightage }}" class="btn btn-rounded btn-sm xs btn-default"></td>
                            <td><input type="text" id="managerscrore" data-max="5" data-required="true" name="managerscrore[]" value="{{ $kpa->manager }}" placeholder="1 of 5" class="form-control rounded"></td> 
                       ...
                       <select id="employee_reason" name="employee_reason"  rows="3" tabindex="1" data-placeholder="Select here.." class="form-control">
                        ...
                        <option value="No">No</option>
                          ...
                          <div class="col-sm-12">
                            ...
                            <textarea type="text" rows="6" class="form-control" id="sup_comment_reason" name="sup_comment_reason" value="{{ Request::old('sup_comment_reason') ?: '' }}">{{ $kpas[0]->sup_comment_reason }}</textarea>   
                         ...
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            ...
                            <textarea type="text" rows="3" class="form-control" id="manager_feedback" name="manager_feedback" value="{{ Request::old('manager_feedback') ?: '' }}">{{ $kpas[0]->manager_feedback }}</textarea>   
                          ...
                          <div class="col-sm-12">
                            ...
                            <textarea type="text" rows="3" class="form-control" id="director_feedback" name="director_feedback" value="{{ Request::old('director_feedback') ?: '' }}">{{ $kpas[0]->director_feedback }}</textarea>   
