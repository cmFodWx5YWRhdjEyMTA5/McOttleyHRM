                       ...
                       <table id="JobTable" cellpadding="0" cellspacing="0" border="0" class="table table-striped m-b-none text-sm" width="100%">
                         <thead>
                          ...
                          <tr>
                            ...
                            <td><input type="text" id="managerscrore" data-max="5" name="managerscrore[]" value="{{ $kpa->manager }}" placeholder="1 of 5" class="form-control rounded"></td> 
                         ...
                         <span class="badge bg-danger"> Employee's Rating : {{ $employeefinal }}%  </span>
                          ...
                          <div class="form-group{{ $errors->has('supervisor') ? ' has-error' : ''}}">
                           <select name="supervisor[]" id="supervisor" data-required="true" style="width:100%" multiple data-placeholder="Select HOD / Director / HR"  >
                         ...
                         <span class="badge bg-danger"> Employee's Rating : {{ $employeefinal }}%  </span>
                          <div class="btn-group pull-right">
                            <p>
                                  ...
                                  <a href="#" class="btn btn-rounded btn-sm btn-primary"><i class="fa fa-fw fa-thumbs-up"></i> Forward this review to HR</a>
                    ...
                    <header class="panel-heading font-bold"></header>
                        <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                      <label>Supervisor’s Comment(s) on the reasons above</label>
                                       <textarea type="text" rows="3" class="form-control" id="sup_comment_reason" name="sup_comment_reason" value="{{ Request::old('sup_comment_reason') ?: '' }}">{{ $kpa->sup_comment_reason }}</textarea>
                                    </div>
                          ...
                          <div class="col-sm-12">
                            ...
                            <textarea type="text" rows="3" class="form-control" id="manager_feedback" name="manager_feedback" value="{{ Request::old('manager_feedback') ?: '' }}">{{ $kpa->manager_feedback }}</textarea>   
                          ...
                          <div class="col-sm-12">
                            ...
                            <textarea type="text" rows="3" class="form-control" id="director_feedback" name="director_feedback" value="{{ Request::old('director_feedback') ?: '' }}">{{ $kpa->director_feedback }}</textarea>   
