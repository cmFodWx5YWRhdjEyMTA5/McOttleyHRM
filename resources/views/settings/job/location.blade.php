            ...
            <aside>
              <section class="vbox">
                ...
                <section class="scrollable wrapper w-f">
                  ...
                  <header class="panel-heading font-bold">Branch
...
<div class="modal fade" id="new-location" style="height:700px">
                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="individual">
                           <form  class="bootstrap-modal-form" method="post" action="/add-new-location" class="panel-body wrapper-lg">
