              ...
              <section class="vbox">
                ...
                <section class="scrollable wrapper w-f">
                  <section class="panel panel-default">
                    <header class="panel-heading font-bold">Employment Status
                                 <a href="#new-employment-status" class="bootstrap-modal-form-open" data-toggle="modal"><span class="badge bg-info pull-right">+</span></a>
                                </header>
...
<div class="modal fade" id="new-employment-status" style="height:700px">
                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="individual">
                           ...
                           @include('settings/job/new_employement_status')
