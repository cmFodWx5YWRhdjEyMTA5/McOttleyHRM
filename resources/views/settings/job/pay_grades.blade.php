              ...
              <section class="vbox">
                <header class="header bg-white b-b clearfix">
                  <div class="row m-t-sm">
                    ...
                    <a href="#" data-toggle="modal" class="btn btn-sm btn-default"><i class="fa fa-print"></i> Print List</a>
                     <span class="badge badge-info">Record(s) Found :  {{ $items->total() }} {{ str_plural('Job Grade', $items->total()) }}</span>
                    </div>
                ...
                <section class="scrollable wrapper w-f">
                  <section class="panel panel-default">
                   <header class="panel-heading font-bold">Job Grade
                                 <a href="#new-pay-grade" class="bootstrap-modal-form-open" data-toggle="modal"><span class="badge bg-info pull-right">+</span></a>
                                </header>
                          ...
                          <tr>
                           ...
                           <td>{{ ++$key }}</td>
                            <td>{{ $item->grade }}</td>
                             ...
                             <td><a href="#modal_check_in" class="bootstrap-modal-form-open" onclick="deleteDetails('{{ $item->id }}','{{ $item->grade }}')"  id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-trash"></i></a>
                             </td>
...
<div class="modal fade" id="new-pay-grade" style="height:700px">
                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="individual">
                           <form  class="bootstrap-modal-form" method="post" action="/add-pay-grade" class="panel-body wrapper-lg">
                           @include('settings/job/new_pay_grade')
