                          ...
                          <tr>
                           ...
                           <td>{{ ++$key }}</td>
                            ...
                            <td>{{ $jobtitle->description }}</td>
                             ...
                             <td><a href="#modal_check_in" class="bootstrap-modal-form-open" onclick="getDetails('{{ $jobtitle->id }}')"  id="edit" name="edit" data-toggle="modal" alt="edit"><i class="fa fa-trash"></i></a>
                             </td>
