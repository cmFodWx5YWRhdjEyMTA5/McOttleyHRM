        ...
        <div class="modal-body">
         <div class="fallback">
          <form method="post" data-validate="parsley"  enctype="multipart/form-data" action="/create-document">
          <input type="text" data-required="true" class="form-control" width="1000px" height="40px" name="filename" id="filename" placeholder="Enter file name" /><br>
          <input type="file" class="form-control dropbox" width="1000px" height="40px" id="image" name="image" /><br>
