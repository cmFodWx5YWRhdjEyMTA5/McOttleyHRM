                      ...
                      <div class="panel-body">
                        ...
                        <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            ...
                            <div class="form-group{{ $errors->has('training_staff') ? ' has-error' : ''}}">
                             <select id="training_staff" name="training_staff" rows="3" tabindex="1" data-placeholder="Select here.." style="width:100%">
                        
                            <option value="{{ Auth::user()->email }}">{{ Auth::user()->fullname }}</option>
                        </select>            
                           @if ($errors->has('training_staff'))
                          <span class="help-block">{{ $errors->first('training_staff') }}</span>
                           @endif    
                          </div>
                          </div>
                        </div>
                    ...
                    <div class="form-group pull-in clearfix">
                        ...
                        <div class="col-sm-6">
                         ...
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-6">
                            <label>Was it inline with your expectation</label> 
                         ...
                         <div class="form-group pull-in clearfix">
                           <div class="col-sm-6">
                            <label>Which subject/session you most enjoyed</label> 
                          ...
                          <div class="col-sm-6">
                            <label>Which subject/session you least enjoyed</label> 
                            <div class="form-group{{ $errors->has('comment') ? ' has-error' : ''}}">
                            <textarea type="text" rows="3" class="form-control" id="comment" name="comment" value="{{ Request::old('comment') ?: '' }}"></textarea>   
                           @if ($errors->has('comment'))
                          <span class="help-block">{{ $errors->first('comment') }}</span>
                      ...
                      <footer class="panel-footer text-right bg-light lter">
                        <button type="button" onclick="savetrainingFeedback()" class="btn btn-success btn-s-xs">Save</button>
                      </footer>
                    </section>