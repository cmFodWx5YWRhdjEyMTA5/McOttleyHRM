            ...
            <aside class="aside-lg b-l">
              <div class="padder">
                ...
                <a href="#new-leave-request"  data-toggle="modal" class="btn btn-sm btn-info bootstrap-modal-form-open"> <i class="fa fa-plus"></i>  Add New Leave Request</a>
                 ...
                 <div class="line"></div>
                <div>
                <a href="/manage-leave"  data-toggle="modal" class="btn btn-sm btn-default bootstrap-modal-form-open"> <i class="fa fa-home"></i>  Proposed Leave Schedule</a>
                </div>
                <div class="line"></div>
                 <div>
