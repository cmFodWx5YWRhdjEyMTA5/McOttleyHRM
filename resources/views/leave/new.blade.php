                        ...
                        <div class="form-group pull-in clearfix">
                         ...
                         <div class="form-group pull-in clearfix">
                          <div class="col-sm-4">
                           ...
                           <select id="leave_type" name="leave_type" rows="3" onchange="getleavedays()"  data-required="true" tabindex="1" data-placeholder="Select here.." class="form-control m-b">
                    ...
                    <div class="form-group pull-in clearfix">
                         ...
                         <div class="form-group">
                          <label>Taken</label>
                          <div class="form-group{{ $errors->has('leave_balance') ? ' has-error' : ''}}">
                          <input type="text" class="form-control" id="leave_balance" readonly="true" name="leave_balance" value="">   
                          @if ($errors->has('leave_balance'))
                          <span class="help-block">{{ $errors->first('leave_balance') }}</span>
                           @endif                           
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                         <div class="form-group">
                          ...
                          <div class="form-group{{ $errors->has('leave_entitlement') ? ' has-error' : ''}}">
                          <input type="number" class="form-control" readonly="true" id="leave_entitlement" name="leave_entitlement" value="">   
                          @if ($errors->has('leave_entitlement'))
                          <span class="help-block">{{ $errors->first('leave_entitlement') }}</span>
                           @endif                           
                        </div>
                        </div>
                        </div>
                        ...
                        <input type="file" class="form-control dropbox" data-requiured="true"  width="1000px" height="40px" id="image" name="image" />
                        </div>
                        </div>
                        </div> --}}
                     ...
                     <header class="panel-heading font-bold">                  
                      ...
                      <div class="panel-body">
                        <div class="form-group pull-in clearfix">
                          <div class="col-sm-12">
                            <label>Select Approving Staff (Reliever , Supervisor, MD)</label> 
                            <div class="form-group{{ $errors->has('reliever') ? ' has-error' : ''}}">
                            <select id="reliever" name="reliever[]" rows="3" multiple data-required="true"  tabindex="1" data-placeholder="Select here.." style="width:100%">
