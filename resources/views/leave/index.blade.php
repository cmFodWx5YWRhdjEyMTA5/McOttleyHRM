        ...
        <section id="content">
          <section class="hbox stretch">
            <aside class="aside-md bg-white b-r" id="subNav">
              ...
              <ul class="nav">
                <li class="b-b b-light"><a href="/active-patients"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>All</a></li>
                <li class="b-b b-light"><a href="/inactive-patients"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Pending Approval</a></li>
                 <li class="b-b b-light"><a href="/inactive-patients"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Cancelled</a></li>
                 <li class="b-b b-light"><a href="/inactive-patients"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Scheduled</a></li>
                  <li class="b-b b-light"><a href="/inactive-patients"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Taken</a></li>
                  <li class="b-b b-light"><a href="/inactive-patients"><i class="fa fa-chevron-right pull-right m-t-xs text-xs icon-muted"></i>Rejected</a></li>
              </ul>
            </aside>
            <aside>
              <section class="vbox">
                <header class="header bg-white b-b clearfix">
                  <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                      ...
                      <a href="#new-leave-request"  data-toggle="modal" class="btn btn-sm btn-dark bootstrap-modal-form-open"><i class="fa fa-group"></i> Create New Leave</a>
                    <a href="#" data-toggle="modal" class="btn btn-sm btn-default"><i class="fa fa-print"></i> Print List</a>
                     <span class="badge badge-info">Record(s) Found : {{ $schedules->total() }} {{ str_plural('Leave', $schedules->total()) }}</span>
                    </div>
...
@stop
 ...
 <div class="modal fade" id="new-leave-request" style="height:700px">
