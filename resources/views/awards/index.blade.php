                ...
                <header class="header bg-white b-b clearfix">
                  <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                      ...
                      <a href="#new-award"  data-toggle="modal" class="btn btn-sm btn-info bootstrap-modal-form-open"><i class="fa fa-trophy"></i> Create New Award</a>
                    <a href="#" data-toggle="modal" class="btn btn-sm btn-default"><i class="fa fa-print"></i> Print List</a>
                     <span class="badge badge-info">Record(s) Found : {{ $cases->total() }} {{ str_plural('Award', $cases->total()) }}</span>
                    </div>
